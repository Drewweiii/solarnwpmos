...
**อ่าน 4 ไฟล์นี้ก่อนเริ่ม ตามลำดับ:**
1. `CLAUDE.md` — กติกาการทำงาน (Handoff Report ภาษาไทย, นโยบาย Thailand-first,
   การแบ่ง Track, การเตือนเรื่องเครดิต)
2. `WORK_SPLIT.md` — ตารางแบ่งงานนวัตกรรมระหว่างสองบัญชี (A-O)
3. `HANDOFF_PROJECTS_IJK.md` — สเปกงานฝั่งเนื้อหา (Demand charge / PV recycling / Power flow)
4. `HANDOFF_PROJECTS_LMNO_UI.md` — **สเปกงานฝั่ง Interface ฉบับเต็ม**

**ตอนนี้คุณมีงานค้าง 2 ชุด:**

**ชุด Interface — L / M / N / O** (user สั่ง 2026-07-26 หลังถามหา "นวัตกรรมล้ำๆ ด้าน interface
แบบทึ่งๆว้าวๆ" แล้วเลือกครบทั้ง 4) · แนะนำเริ่มที่ **N (เสียง)** เพราะไม่ต้องเพิ่ม dependency เลย
และครึ่งหนึ่งมีอยู่แล้ว (`tts.ts` พูดออกได้ + `assistant.ts` จับ intent ได้ เหลือแค่ `SpeechRecognition`)
⚠️ **หัวข้อ L สเปกเปลี่ยนจากที่ user จินตนาการ** — เงาเมฆเป็นรูปร่างทำไม่ได้ (ข้อมูลเมฆเป็นตัวเลข
เดียวทั้งไซต์) แต่เงาดวงอาทิตย์เป็นของจริงและยังไม่ได้ใช้เลย · อ่านในสเปกก่อนเขียนโค้ด

**ชุดเนื้อหา — I / J / K** (user สั่ง 2026-07-25 หลังถามเรื่อง
powerflow / EMS / high voltage / PV recycling) ยังไม่มีใครเริ่ม
