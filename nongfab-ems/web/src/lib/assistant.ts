  ...
  },
  {
    ...
    respond: (_question, ctx) => {
      ...
      const lines = [
        ...
        '• 🏗️ 3D View — ดูโรงงานจำลอง 3 มิติ พร้อมเงา เส้นทางดวงอาทิตย์ และแผนที่ความเข้มแสง (รวมอยู่ในหน้านี้แล้ว)',
        '• 📊 Energy Report — รายงานสรุปพลังงานรายวัน/รายเดือน/รายปี พร้อมค่าไฟที่ประหยัดและคาร์บอนเครดิต',
      ]
